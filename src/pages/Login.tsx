                ...
                <main style={styles.containerInner} aria-label="Login and Information">
                    <section style={{ ...styles.cardBase, ...styles.leftCard }} aria-labelledby="welcome-title">
                        ...
                        <div style={styles.smartEligibilityCard}>
                            ...
                            <div>
                                <h3 style={{ fontSize: '1.25rem', fontWeight: 700, marginBottom: '0.5rem', color: '#475569' }}>
                                    Smart Eligibility
                                </h3>
                                <p style={{ fontSize: '0.9rem', margin: 0, opacity: 0.9, color: '#475569' }}>
                        ...
                        {/* Easy Application */}
                        <div style={styles.easyApplicationCard}>
                            <div style={styles.easyApplicationIcon}>
                                <FileText size={32} />
                            </div>
                            <div>
                                <h3 style={{ fontSize: '1.25rem', fontWeight: 700, marginBottom: '0.5rem', color: '#475569' }}>
                        ...
                        {/* Secure Platform */}
                        <div style={styles.securePlatformCard}>
                            <div style={styles.securePlatformIcon}>
                                <ShieldCheck size={32} />
                            </div>
                            <div>
                                <h3 style={{ fontSize: '1.25rem', fontWeight: 700, marginBottom: '0.5rem', color: '#475569' }}>
                        ...
                        <footer
                        className="d-flex justify-content-between align-items-center text-white p-3 mt-auto"
                        style={{
                    ...
                    >
                        <div className="text-center flex-fill">
                            ...
                            <div style={{ fontSize: '0.875rem', fontWeight: 600, marginTop: '0.2rem' }}>Students Registered</div>
                        </div>
                        <div className="text-center flex-fill">
                            <div style={{ fontSize: '1.5rem', fontWeight: 700 }}>₱2M+</div>
                            <div style={{ fontSize: '0.875rem', fontWeight: 600, marginTop: '0.2rem' }}>Scholarships Awarded</div>
                        </div>
                        <div className="text-center flex-fill">
                            <div style={{ fontSize: '1.5rem', fontWeight: 700 }}>95%</div>
                            <div style={{ fontSize: '0.875rem', fontWeight: 600, marginTop: '0.2rem' }}>Success Rate</div>
                        </div>
                    </footer>
                    </section>
